...
PAGES.append(dict(
    ...
    lead='Ha a rendszer már működik, a kérdés nem a választás, hanem az üzemeltetés. Az alábbi belépési pontok ebben segítenek: hibajelenség, karbantartás, alkatrész és szerviz. Nem tőlünk származó berendezéssel is fordulhat hozzánk — megmondjuk, ha nem tudunk segíteni.',
    crumbs=[HOME, HELY],
    sections=[
        sec_situations(
            ...
            [('nav-szerviz', 'Hibajelenség azonosítása',
              ...
              '#mit-erdemes-megnezni-mielott-szervizt-hiv-cim', 'Első ellenőrzések'),
             ('nav-mukodes', 'Rendszeres karbantartás',
              ...
              '../megoldasok/biologiai-uzemeltetes-es-karbantartas', 'Karbantartás'),
             ('nav-telepites', 'Alkatrész és csere',
              ...
              '../kapcsolat#urlap', 'Alkatrész kérése'),
        ...
        # Az `ugyfeltamogatas/` szekció MÉG NEM ÉPÜLT MEG — addig a szervizkérés
        # a kapcsolati űrlapon megy, és ez a blokk oda visz, nem egy 404-re.
        sec_cta('Ügyféltámogatás', 'Szervizt vagy alkatrészt kér?',
                ['Írja meg a berendezés típusát és a telepítés helyét — a típus az adattábláról olvasható le —, és hogy milyen jelenséget tapasztal.',
                ...
                'Írok a szerviznek', '../kapcsolat#urlap',
                alt=('Vagy hívjon minket: +36 33 200 211', 'tel:+3633200211')),
        sec_faq([
