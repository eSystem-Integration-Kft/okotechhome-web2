...
| **Kész aloldalak** | **Megoldások** (41) · **Helyzetem** (38) · **Projekt-előkészítés** (27) · **Eredmények** (7) · megkeresés és jogi lapok — a főoldallal együtt **132 lap** |
...
| **Öko kalauz** | AI-alapú kísérő minden lapon, három üzemmódban, a megrendelésig vezető hét lépés ismeretében. Navigációs index: **127 lap, 774 szakasz**. **Szövegindex: 943 részlet** — a válasz a lapok tényleges mondataiból jön. Három kódszintű védelem a kitalálás ellen. Végpont: `api/kalauz.php` **Helyszíni segítség:** a `data-oko-pont` attribútummal jelölt felületeknél (ügyazonosító, mentés) magától megszólal, amikor a látogató odagörget. |
