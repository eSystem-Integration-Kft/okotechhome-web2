...
és onnan kerül mind a 146 lapra). Egyetlen bejövő hivatkozása van:
...
- **Laptémák:** a köszönés, a belépő kérdések és a fül kérdései a webhely
  ...
  `eredmenyek/`, `tudastar/`) — útvonal szerint, mert 146 lapra kézi lista
...
`scripts/kalauz-index.py` → `api/kalauz-index.json` (141 lap, 920 szakasz).
...
| **Kész aloldalak** | **Megoldások** (41) · **Kiindulópont** (38) · **Projekt-előkészítés** (27) · **Eredmények** (8) · **Tudástár** (11) · **Rólunk** (4) · megkeresés és jogi lapok — a főoldallal együtt **146 lap**. Minden szekció saját hub-lappal |
...
| **Öko kalauz** | AI-alapú kísérő minden lapon, három üzemmódban, a megrendelésig vezető hét lépés ismeretében. Navigációs index: **141 lap, 920 szakasz**. **Szövegindex: 1110 részlet** — a válasz a lapok tényleges mondataiból jön. Három kódszintű védelem a kitalálás ellen. Végpont: `api/kalauz.php` **Helyszíni segítség:** a `data-oko-pont` attribútummal jelölt felületeknél (ügyazonosító, mentés) magától megszólal, amikor a látogató odagörget. |
